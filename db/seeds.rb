if Rails.env.production? || Rails.env.staging?
  ...
  User.first_or_create!(email: 'creadix@creadix.es', password: 'test123', role: 'superadmin')
  User.first_or_create!(email: 'admin@orpal.es', password: 'orpal123', role: 'admin')

  # create product zone
  pr = Zone.first_or_create!(name: 'DEFAULT')
  unless pr.price.present?
